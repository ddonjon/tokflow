...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <motion.div
      ...
      className="bg-white border-r border-gray-200 flex flex-col flex-shrink-0 h-full overflow-hidden transition-all duration-300"
                    ...
                    <AnimatePresence>
                      {accountDropdownOpen === account.id && (
                        <motion.div
                          ...
                          className="absolute right-0 mt-1 w-32 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden z-20"
                        >
                          <button
